...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_9846hpm",    // replace with your EmailJS service ID
        "template_y8zvxyq",   // replace with your EmailJS template ID
        form.current,
        "GSWLvFRdtMB9vTsC4"     // replace with your EmailJS public key
      )
      .then(
        (result) => {
